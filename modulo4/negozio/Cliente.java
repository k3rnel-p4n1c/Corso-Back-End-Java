...
public class Cliente {
    ...
    /**
     * Questo metodo si occupa di completare l'acquisto, ovvero far pagare il totale al cliente (con eventuali sconti) e svuota il carrello
     * del cliente
     * @param giorno questo parametro è necessario per poter calcolare gli sconti, nel caso in cui sia LUN o MER
     */
    public void completaAcquisto(Giorno giorno) {

        //Controllo se il carrello possiede almeno un prodotto
        if (carrello[0] != null) {
            System.out.println(nome+ " paga: " +totaleDaPagare(giorno));
            svuotaCarrello();
        }
        else
            System.err.println("Non ci sono prodotto nel carrello!");
    }
    ...
    /**
     * Questo metodo semplicemente svuota il carrello istanziando un nuovo array di dimensione 1
     */
